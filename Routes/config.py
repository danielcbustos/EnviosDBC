...
class Config:
    ...
    #SQLALCHEMY_TEST_DATABASE_URI = os.environ.get("TEST_DATABASE_URL", f"postgresql://{os.environ.get('DB_USER')}:{os.environ.get('DB_PASSWORD')}@localhost:5432/test_routes")
